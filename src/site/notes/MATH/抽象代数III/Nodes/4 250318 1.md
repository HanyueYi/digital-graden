...
**_Proof._**
If $V\neq U$, there exists maximal $W\supseteq U$ by [[MATH/抽象代数III/Nodes/4 250318 1#^fbacdf\|#^fbacdf]] and $V+\mathrm{Rad}U\subseteq W\neq U$, contradiction.
□
...
By [[MATH/抽象代数III/Nodes/4 250318 1#^3f1b99\|#^3f1b99]], $\downarrow$ 's are essential. So $f$ is essential iff $\overline f$ is essential.
...
**_Proof._**
By [[MATH/抽象代数III/Nodes/4 250318 1#^3f1b99\|#^3f1b99]], $P\to \mathrm{Rad} P$ and $Q\to \mathrm{Rad} Q$ are essential. Thus $P$ (rep. $Q$) is a projective cover of $P/\mathrm{Rad} P$ (rep. $Q/\mathrm{Rad} Q$). By [[MATH/抽象代数III/Nodes/Projective Cover#^9so7ao\|Projective Cover#^9so7ao]], projective cover is unique up to isomorphism and so we finish the proof. 
□
...
**Remark.** In [[MATH/抽象代数III/Nodes/4 250318 1#^f43ojz\|#^f43ojz]],  if $k$ is a closed field..... some direct sum of matrix ring(?)
