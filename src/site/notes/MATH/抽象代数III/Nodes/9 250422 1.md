---
{"dg-publish":true,"draft":false,"permalink":"/MATH/抽象代数III/Nodes/9 250422 1/","dgPassFrontmatter":true}
---
...
for $\widetilde{(a_n)}=(a_n)+I$. It is well-defined by [[MATH/抽象代数III/Nodes/9 250422 1#^147dxw\|#^147dxw]]. Furthermore, we can check $\widetilde \varphi$ is a multiplicative valuation of $\widetilde k$. 
