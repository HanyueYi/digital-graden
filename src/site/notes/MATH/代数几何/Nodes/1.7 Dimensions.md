...
**_Proof._**
There exists open affine $U_0\subseteq X$ such that $U_0\cap Z\neq \emptyset$. Define $\Gamma(U_0)=R$ with $g=g|_{U_0}\in R$. Then $U_0\cap Z$ is an irreducible component of $\{z\in U_0:g(z)=0\}$. As $\dim Z=\dim (U_0\cap Z)$, it suffices to show $\dim (U_0\cap Z)=\dim U_0-1$. 
